...
static GLuint loadCubemap()
{
    std::vector<std::string>faces = {
        S_PATH("resource/image/skybox/right.png"),
        S_PATH("resource/image/skybox/left.png"),
        S_PATH("resource/image/skybox/top.png"),
        S_PATH("resource/image/skybox/bottom.png"),
        S_PATH("resource/image/skybox/back.png"),
        S_PATH("resource/image/skybox/front.png"),
    };
...
int GLRenderer::Skybox(HWND hwnd, HDC dc, int viewW, int viewH)
{
    ...
    GLuint mainTexture = loadCubemap();
...
int GLRenderer::SkyboxReflection(HWND hwnd, HDC dc, int viewW, int viewH)
{
    ...
    std::cout << "image path = " << S_PATH("resource/image/skybox/right.png") << std::endl;
